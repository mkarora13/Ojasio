...
export const Navbar: React.FC = () => {
  ...
  return (
    <nav className="sticky top-0 z-50 w-full bg-ivory/90 backdrop-blur-md border-b border-gold/20">
      ...
      {/* Mobile Menu Content */}
      <div className={`md:hidden fixed top-[80px] left-0 w-full h-[calc(100vh-80px)] bg-ivory/98 backdrop-blur-xl overflow-y-auto transition-all duration-400 ease-[cubic-bezier(0.22,1,0.36,1)] ${
