    ...
    <div className="w-full">
      ...
      <section aria-label="Our Impact" className="bg-green-deep text-ivory flex items-center justify-around min-h-[12rem] py-10 px-4">
        <div className="max-w-7xl mx-auto w-full flex flex-col md:flex-row items-center justify-around divide-y md:divide-y-0 md:divide-x divide-white/10 gap-8 md:gap-0">
          {stats.map((stat, idx) => (
            <div 
              key={idx} className="text-center w-full"
            >
      ...
      <section className="py-32 text-center bg-ivory border-t border-gold/20">
        <div className="max-w-3xl mx-auto px-4">
          <h2 className="text-4xl md:text-5xl font-display text-green-deep mb-6"
          >
            Initiate Your Metabolic Rehabilitation
          </h2>
          <p className="text-sm font-sans text-green-deep/70 mb-10 leading-relaxed uppercase tracking-widest"
          >
